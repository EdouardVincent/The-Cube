...
black_cube = pygame.image.load('Images//black_cube.png')
...
while game :
    ...
    while start_level :
        ...
        for event in pygame.event.get() :
            ...
            if button_no_rect.collidepoint(mouse_position) and lose == 1 :    
                pygame.quit()
                sys.exit() 

            if button_yes_rect.collidepoint(mouse_position) and lose == 1:    
                level = 0
                lose = 0
                start_level = 0                        
                start_ticks = pygame.time.get_ticks()       
        ...
        #window.blit(black_cube,(642,324))
        ...
        TimeSurf = fond.render('Seconds : %s' %seconds, True, (255, 255, 255))
        window.blit(ScoreSurf,(110,0))
        window.blit(TimeSurf,(110,40))
        if lose == 1 :
            window.blit(background,(0,0))
    ...
    if show_score == 1 :
        ...
        TimeSurf = fond.render('Seconds : %s' %seconds, True, (255, 255, 255))
        window.blit(background,(0,0))
        window.blit(ScoreSurf, (550, 380))
        window.blit(TimeSurf, (550, 420))
        pygame.display.flip()
        time.sleep(4)
        pygame.quit()
        sys.exit()
